...
namespace AppAgenceVoyage2025.Models
{
    public class GMailer
    {
        ...
        public static void senMail(string destinataire, string subjet, string body)
        {
            try
            {
                GMailer.GmailUsername = System.Configuration.ConfigurationManager.AppSettings["mehmetdjigo@gmail.com"];
                //GMailer.GmailUsername = System.Configuration.ConfigurationManager.AppSettings["dieyesokhna2021@gmail.com"];
                //GMailer.GmailPassword = System.Configuration.ConfigurationManager.AppSettings["ubmh zsbv zaau pqir"];
                GMailer.GmailPassword = System.Configuration.ConfigurationManager.AppSettings["zgzw wlvv kfag qqgu"];
